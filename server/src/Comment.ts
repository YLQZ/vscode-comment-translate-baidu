...
export interface IcommentTranslateBaiduSettings {
...
export class Comment {
    ...
    private _setting: IcommentTranslateBaiduSettings;
    ...
    constructor(extensions: ICommentOption, private _documents: TextDocuments, private _connection: Connection) {
        this._setting = { multiLineMerge: false, targetLanguage: "zh"};
    ...
    // setSetting(newSetting: IcommentTranslateBaiduSettings) {
