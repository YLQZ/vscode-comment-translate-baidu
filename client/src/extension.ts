...
export async function activate(context: ExtensionContext) {
    ...
    client.start();
    context.subscriptions.push(commands.registerCommand('commentTranslateBaidu.select', async () => {
    ...
    //翻译选择区域并替换
    context.subscriptions.push(commands.registerCommand('commentTranslateBaidu.replaceSelections', async () => {
        let editor = window.activeTextEditor;
    ...
    // 注册更改目标语言命令
    context.subscriptions.push(commands.registerCommand('commentTranslateBaidu.changeTargetLanguage', changeTargetLanguage));
    // 注册状态图标
